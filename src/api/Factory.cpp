...
int Factory::getVariantHandle(std::string varName_)
{
	...
	if(varName_ == "RV32_OOO"){ return RV32_OOO; }
...
Channel* Factory::getChannel(int var_)
{
  switch((var_t)var_)
  {
	...
	case RV32_OOO: return new RV32_OOO_Channel();
...
Backend* Factory::getPerformanceEstimator(int var_)
{
  ...
  switch((var_t)var_)
  {
	...
	case CVA6:
		...
		break;
	case RV32_OOO:
		perfModel = new RV32_OOO::RV32_OOO_PerformanceModel();
		break;
