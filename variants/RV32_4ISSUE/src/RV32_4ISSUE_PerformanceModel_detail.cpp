...
uint64_t RV32_4ISSUE_PerformanceModel::getCycleCount(void)
{
  ...
  return std::max({
    ...
    ,RN_stage.get(1)
    ,OoO_stage.get(1)
    ,IS_substage_alu.get(1)
    ,LD_substage_alu.get(1)
    ,EX_stage_alu.get(1)
    ,EX_substage_csr
    ,EX_substage_div
    ...
    ,EX_stage_agu.get(1)
    ,EX_substage_agu.get(1)
    ,IS_substage_store.get(1)
    ,LD_substage_store.get(1)
    ,EX_stage_store.get(1)
    ,EX_substage_store.get(1)
    ,COM_stage.get(1)
  });
}
