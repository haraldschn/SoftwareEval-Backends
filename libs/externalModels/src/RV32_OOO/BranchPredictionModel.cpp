...
void BranchPredictModel::setPc_np(uint64_t pc_np_)
{
  branchInstr = true;
...
uint64_t BranchPredictModel::getPc()
{
  if(!branchInstr)
  {
    return pc_p;
...
std::string BranchPredictModel::getInfoHeader()
{
...
std::string BranchPredictModel::getInfoStream()
{
  std::stringstream ret_strs;
